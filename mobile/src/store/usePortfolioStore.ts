...
export const usePortfolioStore = create<PortfolioState>()(
  persist(
    (set, get) => ({
      holdings: [],
      paperHoldings: [
        { id: 'ph1', symbol: 'TATAMOTORS', exchange: 'NSE', quantity: 5, avgBuyPrice: 920, buyDate: '2026-05-10', currentPrice: 952, type: 'paper' },
        { id: 'ph2', symbol: 'HDFCBANK', exchange: 'NSE', quantity: 2, avgBuyPrice: 1650, buyDate: '2026-05-15', currentPrice: 1679, type: 'paper' },
      ],
      tradeHistory: [],
      paperBalance: 100000,
      mode: 'paper',
    ...
    {
      name: 'wealthmaster-portfolio',
      storage: createJSONStorage(() => AsyncStorage),
      partialize: (state) => ({
        holdings: state.holdings,
        paperHoldings: state.paperHoldings,
