    ...
    <div className="space-y-5 pt-4 stagger">
      ...
      <div className="animate-fade-up">
        ...
        <div className="grid grid-cols-4 gap-2">
          <GlassCard className="p-3 text-center"><div className="text-xl font-bold text-text-primary font-[family-name:var(--font-heading)]">{rmaThisMonth.length}</div><div className="text-[8px] tracking-[1.5px] text-text-muted mt-0.5">TOTAL</div></GlassCard>
          <GlassCard className="p-3 text-center"><div className="text-xl font-bold text-pink-500 font-[family-name:var(--font-heading)]">{rmaOpen}</div><div className="text-[8px] tracking-[1.5px] text-text-muted mt-0.5">OPEN</div></GlassCard>
          <GlassCard className="p-3 text-center"><div className="text-xl font-bold text-emerald-500 font-[family-name:var(--font-heading)]">{rmaClosed}</div><div className="text-[8px] tracking-[1.5px] text-text-muted mt-0.5">CLOSED</div></GlassCard>
          <GlassCard className="p-3 text-center"><div className="text-xl font-bold text-amber-500 font-[family-name:var(--font-heading)]">{rmaReady}</div><div className="text-[8px] tracking-[1.5px] text-text-muted mt-0.5">READY</div></GlassCard>
        </div>
      </div>
      ...
      <div className="animate-fade-up">
        ...
        <div className="grid grid-cols-4 gap-2">
          <GlassCard className="p-3 text-center"><div className="text-xl font-bold text-text-primary font-[family-name:var(--font-heading)]">{svcThisMonth.length}</div><div className="text-[8px] tracking-[1.5px] text-text-muted mt-0.5">TOTAL</div></GlassCard>
          <GlassCard className="p-3 text-center"><div className="text-xl font-bold text-violet-500 font-[family-name:var(--font-heading)]">{svcOpen}</div><div className="text-[8px] tracking-[1.5px] text-text-muted mt-0.5">OPEN</div></GlassCard>
          <GlassCard className="p-3 text-center"><div className="text-xl font-bold text-emerald-500 font-[family-name:var(--font-heading)]">{svcClosed}</div><div className="text-[8px] tracking-[1.5px] text-text-muted mt-0.5">CLOSED</div></GlassCard>
          <GlassCard className="p-3 text-center"><div className="text-xl font-bold text-orange-500 font-[family-name:var(--font-heading)]">{svcPending}</div><div className="text-[8px] tracking-[1.5px] text-text-muted mt-0.5">PENDING</div></GlassCard>
        </div>
      </div>
