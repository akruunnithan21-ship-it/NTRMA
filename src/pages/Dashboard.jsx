...
import { Plus, RotateCcw, Box, ArrowRight, Search } from 'lucide-react'
    ...
    <div className="space-y-5 pt-4 stagger">
      ...
      <GlassCard className="p-6 animate-fade-up">
        <div className="flex items-center gap-4">
          <img src="/assets/logo.svg" alt="Neo Tokyo" className="w-14 h-14 drop-shadow-[0_0_16px_rgba(231,1,70,0.4)]" />
          <div>
            <h2 className="text-lg font-bold tracking-wider text-text-primary dark:text-white">NEO TOKYO</h2>
      ...
      <div className="relative animate-fade-up">
        ...
        {searchResults.length > 0 && (
          <div className="absolute top-full left-0 right-0 mt-2 z-50 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl border border-white/80 dark:border-gray-700 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.12)] max-h-64 overflow-y-auto">
              ...
              {searchResults.map(t => (
                <button key={t.id} onClick={() => { setQuickSearch(''); navigate(`/rma/${t.id}`) }}
                  ...
                  <div className="text-left min-w-0">
                    <div className="text-sm font-medium text-text-primary dark:text-white truncate">{t.customer_name || '—'}</div>
      ...
      <div className="grid grid-cols-2 gap-3 animate-fade-up">
        <GlassCard className="p-4 text-center">
          <div className="text-2xl font-bold text-text-primary dark:text-white font-mono">{tickets.length}</div>
      ...
      <div className="animate-fade-up">
        <div className="flex items-center justify-between mb-3 px-1">
          <h3 className="text-[11px] tracking-[3px] font-semibold text-text-secondary dark:text-gray-400 uppercase">Recent Tickets</h3>
